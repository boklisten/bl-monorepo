...
type TokenPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/token.ts')['tokenValidator']>>
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/auth/tokens_controller.ts').default['token'], true>
}
type AuthIdRedirectGetHead = {
  request: unknown
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/auth/social_controller.ts').default['redirect'], false>
}
type AuthIdCallbackGetHead = {
  request: unknown
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/auth/social_controller.ts').default['callback'], false>
}
type AuthLocalLoginPost = {
  request: unknown
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/auth/local_controller.ts').default['login'], false>
}
type AuthLocalRegisterPost = {
  request: unknown
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/auth/local_controller.ts').default['register'], false>
}
type WaitingListEntriesGetHead = {
  request: unknown
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/waiting_list_entries_controller.ts').default['getAllWaitingListEntries'], false>
}
type WaitingListEntriesPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/waiting_list.ts')['waitingListEntryValidator']>>
  response: MakeNonSerializedTuyauResponse<import('../app/controllers/waiting_list_entries_controller.ts').default['addWaitingListEntry'], true>
}
