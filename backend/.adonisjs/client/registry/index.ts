...
const routes = {
  'auth.legacyToken': {
    ...
    types: placeholder as Registry['auth.legacyToken']['types'],
  },
  'v2.auth.token': {
    methods: ["POST"],
    pattern: '/v2/token',
    tokens: [{"old":"/v2/token","type":0,"val":"v2","end":""},{"old":"/v2/token","type":0,"val":"token","end":""}],
    types: placeholder as Registry['v2.auth.token']['types'],
  },
  'auth.vipps.redirect': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['auth.vipps.redirect']['types'],
  },
  'auth.vipps.callback': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['auth.vipps.callback']['types'],
  },
  'auth.local.login': {
    methods: ["POST"],
    ...
    types: placeholder as Registry['auth.local.login']['types'],
  },
  'auth.local.register': {
    methods: ["POST"],
    ...
    types: placeholder as Registry['auth.local.register']['types'],
  },
  ...
  'auth.password.reset.validate': {
    ...
    tokens: [{"old":"/reset_password/validate","type":0,"val":"reset_password","end":""},{"old":"/reset_password/validate","type":0,"val":"validate","end":""}],
    types: placeholder as Registry['auth.password.reset.validate']['types'],
  },
  'auth.password.reset': {
    methods: ["POST"],
  ...
  'waiting_list_entries.getAll': {
    ...
    types: placeholder as Registry['waiting_list_entries.getAll']['types'],
  },
  'waiting_list_entries.add': {
    methods: ["POST"],
    pattern: '/waiting_list_entries',
    tokens: [{"old":"/waiting_list_entries","type":0,"val":"waiting_list_entries","end":""}],
    types: placeholder as Registry['waiting_list_entries.add']['types'],
  },
  'waiting_list_entries.delete': {
    ...
    types: placeholder as Registry['waiting_list_entries.delete']['types'],
  },
  ...
  'branches.addMemberships': {
    ...
    types: placeholder as Registry['branches.addMemberships']['types'],
  },
  'branches.addSubjectChoices': {
    ...
    types: placeholder as Registry['branches.addSubjectChoices']['types'],
  },
  'branches.relationships.update': {
    ...
    types: placeholder as Registry['branches.relationships.update']['types'],
  },
  'branches.memberships.get': {
    ...
    types: placeholder as Registry['branches.memberships.get']['types'],
  },
  'branches.memberships.update': {
    ...
    types: placeholder as Registry['branches.memberships.update']['types'],
  },
  'branches.memberships.remove.direct': {
    ...
    types: placeholder as Registry['branches.memberships.remove.direct']['types'],
  },
  'branches.memberships.remove.indirect': {
    ...
    types: placeholder as Registry['branches.memberships.remove.indirect']['types'],
  },
  'open_orders.get': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['open_orders.get']['types'],
  },
  'open_orders.cancel': {
    methods: ["POST"],
    ...
    types: placeholder as Registry['open_orders.cancel']['types'],
  },
  'editable_texts.getAll': {
    methods: ["GET","HEAD"],
    pattern: '/editable_texts',
    tokens: [{"old":"/editable_texts","type":0,"val":"editable_texts","end":""}],
    types: placeholder as Registry['editable_texts.getAll']['types'],
  },
  'editable_texts.getByKey': {
    ...
    types: placeholder as Registry['editable_texts.getByKey']['types'],
  },
  ...
  'questions_and_answers.getAll': {
    ...
    types: placeholder as Registry['questions_and_answers.getAll']['types'],
  },
  ...
  'blid.lookup': {
    ...
    types: placeholder as Registry['blid.lookup']['types'],
  },
  'matches.generate': {
    methods: ["POST"],
  ...
  'matches.getMyMatches': {
    ...
    types: placeholder as Registry['matches.getMyMatches']['types'],
  },
  ...
  'user_detail.getById': {
    ...
    types: placeholder as Registry['user_detail.getById']['types'],
  },
  'user_detail.getMyDetails': {
    ...
    types: placeholder as Registry['user_detail.getMyDetails']['types'],
  },
  'user_detail.updateAsCustomer': {
    ...
    types: placeholder as Registry['user_detail.updateAsCustomer']['types'],
  },
  'user_detail.updateAsEmployee': {
    ...
    types: placeholder as Registry['user_detail.updateAsEmployee']['types'],
  },
  'customer_items.get': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['customer_items.get']['types'],
  },
  'signatures.send.link': {
    ...
    types: placeholder as Registry['signatures.send.link']['types'],
  },
  'signatures.me.send': {
    methods: ["POST"],
    ...
    types: placeholder as Registry['signatures.me.send']['types'],
  },
  'signatures.valid': {
    methods: ["GET","HEAD"],
  ...
  'signatures.get': {
    ...
    types: placeholder as Registry['signatures.get']['types'],
  },
  'signatures.sign': {
    methods: ["POST"],
  ...
  'unique_ids.download.pdf': {
    ...
    types: placeholder as Registry['unique_ids.download.pdf']['types'],
  },
  'users.create': {
    methods: ["POST"],
  ...
  'order_history.get.my.order': {
    ...
    types: placeholder as Registry['order_history.get.my.order']['types'],
  },
  'order_history.get.my.orders': {
    ...
    types: placeholder as Registry['order_history.get.my.orders']['types'],
  },
  'checkout.initialize': {
    methods: ["POST"],
    pattern: '/checkout',
  ...
  'checkout.vipps.callback': {
    ...
    types: placeholder as Registry['checkout.vipps.callback']['types'],
  },
  'checkout.poll': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['checkout.poll']['types'],
  },
  'subjects.get.branch.subjects': {
    ...
    types: placeholder as Registry['subjects.get.branch.subjects']['types'],
  },
  'branch_items.get': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['branch_items.get']['types'],
  },
  'branch_items.post': {
    methods: ["POST"],
    pattern: '/branch_items',
    tokens: [{"old":"/branch_items","type":0,"val":"branch_items","end":""}],
    types: placeholder as Registry['branch_items.post']['types'],
  },
  'lookup.postal.code': {
    methods: ["GET","HEAD"],
    ...
    types: placeholder as Registry['lookup.postal.code']['types'],
  },
  'companies.get': {
    methods: ["GET","HEAD"],
    pattern: '/v2/companies',
    tokens: [{"old":"/v2/companies","type":0,"val":"v2","end":""},{"old":"/v2/companies","type":0,"val":"companies","end":""}],
    types: placeholder as Registry['companies.get']['types'],
  },
  'companies.add': {
    methods: ["POST"],
    pattern: '/v2/companies',
    tokens: [{"old":"/v2/companies","type":0,"val":"v2","end":""},{"old":"/v2/companies","type":0,"val":"companies","end":""}],
    types: placeholder as Registry['companies.add']['types'],
  },
  'companies.delete': {
    methods: ["DELETE"],
    ...
    types: placeholder as Registry['companies.delete']['types'],
  },
  'opening_hours.get': {
    methods: ["GET","HEAD"],
  ...
  'dispatch.get.email_templates': {
    ...
    types: placeholder as Registry['dispatch.get.email_templates']['types'],
  },
  'dispatch.create': {
    methods: ["POST"],
    pattern: '/dispatch',
    tokens: [{"old":"/dispatch","type":0,"val":"dispatch","end":""}],
    types: placeholder as Registry['dispatch.create']['types'],
  },
  ...
  'collection.orders.operation.rapid-handout.post': {
    ...
    tokens: [{"old":"/orders/rapid-handout","type":0,"val":"orders","end":""},{"old":"/orders/rapid-handout","type":0,"val":"rapid-handout","end":""}],
    types: placeholder as Registry['collection.orders.operation.rapid-handout.post']['types'],
  },
