...
function createRequestHandler(endpoint, collection, onRequest, checkDocumentPermission) {
...
function create(endpoint, collection) {
    ...
    if (endpoint.operations) {
        for (const operation of endpoint.operations) {
            CollectionEndpointOperation.create(collectionUri, endpoint.method, operation);
        }
    }
}
