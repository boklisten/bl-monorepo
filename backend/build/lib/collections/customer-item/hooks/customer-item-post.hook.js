...
export class CustomerItemPostHook extends Hook {
    ...
    userDetailHelper;
    constructor(customerItemValidator, userDetailHelper) {
        super();
    ...
    before(customerItem) {
        ...
        return BlStorage.UserDetails.get(customerItem.customer)
            ...
            return this.customerItemValidator
                ...
                .catch((customerItemValidationError) => {
    ...
    after(customerItems, accessToken) {
